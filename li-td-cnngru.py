...
data_name='suochi_0.3_20=cnngru'
...
if data_name=='suochi_0.3_20=cnngru':
...
if data_name=='bench_finite=cnngru':
    timesteps = 20
...
# con1=Conv2D(32, kernel_size=(5,5),activation='relu',padding="same")(input)
# con1=MaxPool2D(pool_size=(2, 2))(con1)
#
# con2=Conv2D(32, kernel_size=(5,5),activation='relu',padding="same")(con1)
# con2=MaxPool2D(pool_size=(2, 2))(con2)

con1=Conv1D(32, kernel_size=5,activation='relu')(input)
#con1=MaxPool1D(pool_size=(2))(con1)
# con2=Conv1D(32, kernel_size=8,activation='relu',padding='same')(input)
# con3=Conv1D(32, kernel_size=12,activation='relu',padding='same')(input)
# body = concatenate([con1,con2,con3])
# gru=Bidirectional(GRU(32,return_sequences=True))(body )
gru=GRU(32,return_sequences=True)(con1)
gru=GRU(32)(gru)
dense=Dense(256,activation='relu')(gru)
...
callbacks=[
    ...
    ModelCheckpoint('./'+data_name+'/'+data_name+'_model'+r+'.h5',monitor = 'loss',save_best_only=True),
]
history=model.fit(x_train,y_train,batch_size=bantch,epochs=100,validation_split=0.33,callbacks=callbacks,shuffle=True)
...
plt.savefig('./'+data_name+'/'+data_name+r+'_CNNGRU_acc.png')
plt.clf()
...
plt.savefig('./'+data_name+'/'+data_name+r+'_CNNGRU_loss.png')
plt.clf()