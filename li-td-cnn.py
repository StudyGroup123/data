...
# 0layer
con1=Conv2D(32, kernel_size=(5,5),activation='relu')(input) #SAME speed will slow，but accwil be high
con1=Dropout(0.1)(con1)
con2=Conv2D(64, kernel_size=(5,5),activation='relu')(con1) #SAME speed will slow，but accwil be high
con1=Dropout(0.1)(con1)
con3=Conv2D(32, kernel_size=(5,5),activation='relu')(con2)
flatten=Flatten()(con3)
